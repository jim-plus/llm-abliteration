...
def apply_abliteration(
    ...
    for layer_idx in tqdm(
        ...
        layer_base.layers[layer_idx].self_attn.o_proj.weight = modify_tensor_norm_preserved(
        ...
        torch.cuda.empty_cache()
        gc.collect()
        layer_base.layers[layer_idx].mlp.down_proj.weight = modify_tensor_norm_preserved(
